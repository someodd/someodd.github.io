...
[Primary source of truth for my Counter-Strike 1.6 server](gopher://gopher.someodd.zip:70/0/services/counter-strike.md)

We will be on voice chat:

[Mumble (voice chat)](gopher://gopher.someodd.zip:70/0/services/mumble.md)

Join the text chats, too:

[XMPP (more modern, generally easier)](gopher://gopher.someodd.zip:70/0/services/xmpp.md)
...
Original content in gopherspace: [gopher://gopher.someodd.zip:70/1/phlog/announcing-counter-strike-16-weekly-event.gopher.txt](gopher://gopher.someodd.zip:70/1/phlog/announcing-counter-strike-16-weekly-event.gopher.txt)
