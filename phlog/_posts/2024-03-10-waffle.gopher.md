...
date: 2024-03-10
image:
  caption: Animation of Waffle's customization features.
  path: /assets/showcase/waffle/waffle-customization.gif
  thumbnail: /assets/showcase/waffle/waffle-customization.gif
tags:
- nix
- gopher
- haskell
...
Original content in gopherspace: [gopher://gopher.someodd.zip:70/1/phlog/waffle.gopher.txt](gopher://gopher.someodd.zip:70/1/phlog/waffle.gopher.txt)
