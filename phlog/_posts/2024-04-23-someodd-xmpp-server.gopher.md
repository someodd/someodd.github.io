...
Original content in gopherspace: [gopher://gopher.someodd.zip:70/0/phlog/someodd-xmpp-server.gopher.txt](gopher://gopher.someodd.zip:70/0/phlog/someodd-xmpp-server.gopher.txt)
